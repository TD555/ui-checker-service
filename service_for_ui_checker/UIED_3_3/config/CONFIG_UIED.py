class Config:
    ...
    def __init__(self):
        # Adjustable
        self.THRESHOLD_PRE_GRADIENT = 1             # dribbble:4 rico:4 web:1
        self.THRESHOLD_OBJ_MIN_AREA = 55            # bottom line 55 of small circle
        self.THRESHOLD_BLOCK_GRADIENT = 5

        # *** Frozen ***
        
        # self.THRESHOLD_REC_MIN_EVENNESS = 0.5
        # self.THRESHOLD_REC_MAX_DENT_RATIO = 0.25
        # self.THRESHOLD_LINE_THICKNESS = 1
        # self.THRESHOLD_LINE_MIN_LENGTH = 0.5
        ...
        # self.THRESHOLD_BLOCK_MIN_HEIGHT = 0.13  # 24/800
        
        self.THRESHOLD_REC_MIN_EVENNESS = 0.1
        self.THRESHOLD_REC_MAX_DENT_RATIO = 0.15
        self.THRESHOLD_LINE_THICKNESS = 111
        self.THRESHOLD_LINE_MIN_LENGTH = 0.5
        self.THRESHOLD_COMPO_MAX_SCALE = (0.1, 0.99)  # (120/800, 422.5/450) maximum height and width ratio for a atomic compo (button)
        self.THRESHOLD_TEXT_MAX_WORD_GAP = 10
        self.THRESHOLD_TEXT_MAX_HEIGHT = 0.14  # 40/800 maximum height of text
        self.THRESHOLD_TOP_BOTTOM_BAR = (0.1, 0.94)  # (36/800, 752/800) height ratio of top and bottom bar
        self.THRESHOLD_BLOCK_MIN_HEIGHT = 0.05  # 24/800
        ...
        self.CLASS_MAP = {'0':'Button', '1':'CheckBox', '2':'Chronometer', '3':'EditText', '4':'ImageButton', '5':'ImageView',
               ...
               '12':'ToggleButton', '13':'VideoView', '14':'TextView', '15' : 'Block'}
        self.COLOR = {'Button': (0, 255, 0), 'CheckBox': (0, 0, 255), 'Chronometer': (255, 166, 166),
                      ...
                      'TextView': (169, 255, 0), 'Compo' : (0, 0, 255),

                      'Text':(169, 255, 0), 'Non-Text':(255, 0, 166),

                      'Noise':(6,6,255), 'Non-Noise': (6,255,6),

                      'Image':(255,6,6), 'Non-Image':(6,6,255), 'Block' : (255, 0, 0)}
